...
class Product(models.Model):
    ...
    promotion_plan = models.ForeignKey(
        "PromotionPlan", on_delete=models.SET_NULL, blank=True, null=True
    )
...
class ProductReview(models.Model):
    ...
    rating = models.PositiveIntegerField(
        default=5
    )  # Rating from 1 to 5, you can customize this
...
class FileUpload(models.Model):
    cartId = models.ImageField(
        upload_to=upload_location, height_field=None, width_field=None, max_length=None
    )
