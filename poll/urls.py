...
router.register("", api.PollAPI, basename="poll")
router.register("all-polls", api.AllPollsAPI, basename="all-polls")
...
#     path(
#         "polls-with-vote-count/",
#         PollsWithVoteCountView.as_view(),
#         name="polls-with-vote-count",
#     ),
#     path(
#         "polls/results/<int:poll_id>/", PollResultsView.as_view(), name="poll-results"
#     ),
# ]
