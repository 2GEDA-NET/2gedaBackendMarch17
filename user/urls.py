...
urlpatterns = [
    ...
    path(
        ...
        UserProfileHasUpdatedProfileView.as_view(),
    ...
    path("list-stickers/<int:user_id>/", list_stickers, name="list_stickers"),
    path("list-sticking/<int:user_id>/", list_sticking, name="list_sticking"),
    ...
    path(
        ...
        BusinessAvailabilityListCreateView.as_view(),
        name="business-availability-list",
    ),
    path(
        "business-availability/<int:pk>/",
        BusinessAvailabilityDetailView.as_view(),
        name="business-availability-detail",
    ),
    path(
        "business-profile/",
        BusinessAccountListCreateView.as_view(),
        name="business-profile-list",
    ),
    path(
        "business-profile/<int:pk>/",
        BusinessAccountDetailView.as_view(),
        name="business-profile-detail",
    ),
    path(
        "business-category/",
        BusinessCategoryListCreateView.as_view(),
        name="business-category-list",
    ),
    path(
        "business-category/<int:pk>/",
        BusinessCategoryDetailView.as_view(),
    ...
    path(
        "verification/<int:pk>/",
        VerificationRetrieveView.as_view(),
    ...
    path(
        "get_encryption_keys/",
        EncryptionKeyAPIView.as_view(),
        name="get_encryption_keys",
    ),
    # Business authentication
    path(
        "business/register/",
        BusinessAccountRegistrationView.as_view(),
        name="business_account_register",
    ),
    path(
        "business/login/",
        BusinessAccountLoginView.as_view(),
        name="business_account_login",
    ),
    path(
        "business-accounts/",
        ManagedBusinessAccountsView.as_view(),
        name="managed_business_accounts",
    ),
    path(
        "business/change-password/",
        BusinessAccountChangePasswordView.as_view(),
