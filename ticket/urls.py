...
urlpatterns = [
    ...
    path(
        ...
        views.request_event_promotion,
        name="request-event-promotion",
    ),
    path(
        "manage-event-promotion-requests/",
        views.manage_event_promotion_requests,
        name="manage-event-promotion-requests",
    ),
    path("delete-event/<int:event_id>/", views.delete_event, name="delete-event"),
    path(
        "ticket-report/<int:event_id>/",
        views.TicketReportAPIView.as_view(),
        name="ticket-report",
    ),
    path(
        "download-ticket-report/<int:event_id>/",
        views.download_ticket_report,
        name="download-ticket-report",
    ),
    ...
    path(
        "upcoming-events/",
        views.UpcomingEventsAPIView.as_view(),
        name="upcoming-events",
    ),
    path(
        "create-withdrawal-request/",
        WithdrawDetailView.as_view(),
        name="create-withdrawal-request",
    ),
    path(
        "approve-withdrawal-request/<int:pk>/",
        views.ApproveWithdrawalRequestAPIView.as_view(),
        name="approve-withdrawal-request",
    ),
]
